...
3. **Search budget** — 63 direct-logistic candidates (+ optional blend challenger),
   not 341k temperature/shift settings.
...
6. **Uncertainty** — date-block bootstrap; calibration intercept/slope/ECE.
